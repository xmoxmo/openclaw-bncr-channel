...
const requiredSourceFiles = [
  ...
  'src/core/targets.ts',
  'src/core/types.ts',
  'src/messaging/inbound/command-owner.ts',
  ...
  'src/openclaw/session-reset-runtime.ts',
  ...
  'src/messaging/inbound/conversation-history-serial.ts',
  'src/messaging/inbound/history-shard-worker.ts',
